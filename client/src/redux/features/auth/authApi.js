...
export const authApi = apiSlice.injectEndpoints({
  ...
  endpoints: (builder) => ({
    ...
    signUpProvider: builder.mutation({
      query: (token) => ({
        url: `${BASE_URL}/api/user/register/${token}`,
        method: "POST",
      }),
    ...
    // confirmEmail
    confirmEmail: builder.query({
      query: (token) => `${BASE_URL}/api/user/confirmEmail/${token}`,
    ...
    confirmForgotPassword: builder.mutation({
      query: (data) => ({
        url: `${BASE_URL}/api/user/confirm-forget-password`,
        method: "PATCH",
        body: data,
      }),
    }),
    ...
    updateProfile: builder.mutation({
      query: ({ id, ...data }) => ({
        url: `${BASE_URL}/api/user/update-user/${id}`,
        method: "PUT",
        body: data,
      }),
